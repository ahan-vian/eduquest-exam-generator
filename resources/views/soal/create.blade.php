...
<div class="card shadow-sm border-0 mb-5">
    <div class="card-header bg-white border-0 pt-4 pb-0">
        ...
        <p class="text-muted small">Anda dapat menggunakan sintaks LaTeX (diapit dengan tanda $$) untuk menulis rumus fisika pada kolom pertanyaan dan opsi jawaban.</p>
    </div>
    <div class="card-body">
        <form action="/soal/store" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="topik" class="form-control" placeholder="Contoh: Hukum Termodinamika" required>
                </div>
            </div>

            <div class="mb-4">
                <label class="form-label fw-bold">Pertanyaan Utama</label>
                <textarea name="pertanyaan" class="form-control" rows="5" placeholder="Ketik pertanyaan di sini..." required></textarea>
            </div>
