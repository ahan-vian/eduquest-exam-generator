        ...
        <table class="table table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ Str::limit($s->pertanyaan, 50) }}</td>
                    ...
                    <td class="text-center">
                        <a href="/soal/hapus/{{ $s->id }}" class="btn btn-danger btn-sm" onclick="return confirm('Hapus soal ini?')">Hapus</a>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="6" class="text-center text-muted py-4">Belum ada bank soal. Silakan tambah soal baru.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
